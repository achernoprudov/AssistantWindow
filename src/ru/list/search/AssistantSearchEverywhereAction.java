...
public class AssistantSearchEverywhereAction extends AnAction implements CustomComponentAction, DumbAware, DataProvider, RightAlignedToolbarAction {
    ...
    private static final Logger LOG = Logger.getInstance("#" + AssistantSearchEverywhereAction.class.getName());

    private AssistantSearchEverywhereAction.MyListRenderer myRenderer;
...
//      myPopupField.getTextEditor().setBackground(showAll.get() ? new JBColor(new Color(0xffffe4), new Color(0x494539)) : UIUtil.getTextFieldBackground());
    ...
    private class MyListRenderer extends ColoredListCellRenderer {
        ...
        MyListRenderer(@NotNull JBList myList) {
            assert myList == AssistantSearchEverywhereAction.this.myList;
        }
